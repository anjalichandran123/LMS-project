...
studentRouter.get("/lessons/:lesson_id/students/:student_id/getAssignmentsForStudent",authenticateStudent,getAssignmentsForStudent);
...
studentRouter.get("/getQuizForLesson/:course_id/:module_id/:lesson_id/:student_id",authenticateStudent,getQuizForLesson);
studentRouter.get("/:course_id/:module_id/:lesson_id/:quiz_id/:student_id/getQuestionsForQuiz",authenticateStudent,getQuestionsForQuiz);
...
studentRouter.post("/submitAssignment/:batch_id/:lesson_id",upload.single("file"),authenticateStudent,submitAssignment);
